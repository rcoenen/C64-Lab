## Commodore 64 programming manual table


# TABLE OF CONTENTS

1. [Graphics for Advanced Users](#chapter-2-advanced-graphics)
   - [2.1 Graphics on the Commodore 64](#21-graphics-on-the-commodore-64)
   - [2.2 3D Graphics - BASIC Program](#22-3d-graphics---basic-program)
   - [2.3 Colored Bar Graph](#23-color-bar-graphics)
   - [2.4 Definition of Your Own Character Set](#24-definition-of-your-own-character-set)
   - [2.5 Modification of the Character Set with Joystick](#25-modification-of-the-character-set-using-joystick)
   - [2.6 The Split Screen](#26-the-split-screen)
   - [2.7 Soft Scrolling](#27-soft-scrolling)
   - [2.8 The Keyboard Layout and Its Changes](#28-the-keyboard-layout-and-their-changes)

3. [Data Entry with Convenience](#chapter-3-data-entry-with-convenience)
   - [3.1 Cursor Positioning and Query of Cursor Position](#31-cursor-positioning-and-query-of-the-cursor-position)
   - [3.2 Switch Cursor On and Off](#32-switch-cursor-on-and-off)
   - [3.3 Repeat Function for All Buttons](#33-repeat-function-for-all-buttons)
   - [3.4 The WAIT Command: Waiting for a Key Press](#34-the-wait-command-wait-for-a-keypress)
   - [3.5 The Assignment of the Function Keys](#35-the-assignment-of-the-function-keys-of-the-commodore-64)
   - [3.6 A Convenient INPUT Routine](#36-a-convenient-input-routine)
   - [3.7 The "Mouse" on the 64: Simulation with Joystick](#37-the-mouse-on-the-64-simulation-with-the-joystick)

## Commodore 64 programming manual


4. [BASIC for Advanced Users](#chapter-4-basic-for-advanced-users)
   - [4.1 Creating a BASIC Line in BASIC](#41-create-a-basic-line-in-basic)
   - [4.2 Copying the BASIC Interpreter into RAM](#42-copying-the-basic-interpreter-into-ram)
   - [4.3 No More Negative Numbers in the FRE Function](#43-no-more-negative-numbers-in-the-fre-function)
   - [4.4 Return to BASIC Program After LIST](#44-return-to-basic-program-after-a-list-command)
   - [4.5 GOTO, GOSUB and RESTORE with Calculated Line Numbers](#45-calculated-line-numbers-in-goto-gosub-and-restore)
   - [4.6 The MID$ Command](#46-the-mid-command)
   - [4.7 INSTR and STRING$ Function](#47-instr-and-string-function)
   - [4.8 Automatic Line Numbering](#48-automatic-line-numbering)
   - [4.9 DEF FN - The Unknown Being](#49-def-fn---the-unknown-being)
   - [4.10 Your Commodore 64 Speaks German](#410-your-commodore-64-speaks-german)
   - [4.11 Using a HARDCOPY Routine for Commercial Programs](#411-basic-hardcopy-routine-and-its-application)
   - [4.12 Real Time Clock and Sprites](#412-set-theory-on-the-cbm-64-using-an-example-using-the-berlin-kufdamm-clock-the-real-time-clock-and-sprites)
   - [4.13 A Little Copy Protection](#413-a-little-copy-protection)

5. [The CBM 64 Can't Just Do BASIC](#5-the-cbm-64-cant-just-do-basic)
   - [5.1 Programming FORTH](#51-programming-forth)
   - [5.2 FORTH-BASIC Comparison Program](#52-comparison-program-forth---basic)
   - [5.3 Other Languages: PASCAL, LOGO](#53-other-languages-pascal-logo-turtle-graphics)
   - [5.4 ADA for the Commodore 64](#54-ada-for-the-commodore-64)

6. [CP/M on the Commodore 64](#6-cpm-on-the-commodore-64)
   - [6.1 This is CP/M](#61-this-is-cpm)
   - [6.2 Handling Individual CP/M Programs](#62-handling-the-individual-cpm-programs)

## Commodore 64 technical manual sections


   - [6.3 Adapting CP/M Standard Software to the 64](#63-adapting-standard-cpm-software-to-the-c-64)
   - [6.4 Memory Management of the Z80 Processor](#64-the-memory-management-of-the-z80-processor)
   - [6.5 Diskette Management Under CP/M](#65-disk-management-under-cpm)
   - [6.6 Cooperation of the Processors 6510 - Z80](#66-the-collaboration-between-6510-and-z80)
   - [6.7 Commented BIOS Listing](#671-loading-program-for-bios-65)
   - [6.8 Implementation of Own I/O Functions in BIOS](#68-implementation-of-own-inputoutput-functions-in-the-bios)
   - [6.9 Transferring Programs and Data Between CP/M and Commodore-BASIC](#69-transfer-of-cpm-programs-and-data-into-commodore-basic-and-vice-versa)

7. [Connection and Expansion Options for the Commodore 64](#chapter-7-connection-and-expansion-options-of-the-commodore-64)
   - [7.1 USER Port Application: Centronics Printer](#71-a-useful-use-of-the-user-port-interface-for-a-centronics-printer)
   - [7.2 Data Transfer Using USER Port](#72-data-transfer-from-and-to-other-computers-using-the-user-port)
   - [7.3 The Expansion Port: CP/M Cartridge Case Study](#73-the-cpm-cartridge-on-the-expansion-port-a-case-study)
   - [7.4 Synthesizer in Stereo](#74-synthesizer-in-stereo)

8. [File Management: No Closed Book](#8-file-management-no-closed-book-230)
   - [8.1 Cassette - Floppy Disk](#81-cassette---disk)
   - [8.2 The Principle of File Management: Sequential Files](#82-the-principle-of-file-management-sequential-files)
   - [8.3 Copying Files with One and Two Drives](#83-copying-files-with-one-and-two-drives)
   - [8.4 How to Do It Faster: Relative Files](#84-how-to-do-it-faster-relative-files)
   - [8.5 Another Method: Direct Access](#85-another-method-direct-access)
   - [8.6 Rescuing an Improperly Closed File](#86-saving-a-file-that-is-not-properly-closed)
   - [8.7 The Block Chaser](#87-the-block-chaser)

## Commodore 64 programming routines guide

9. [POKE's and Other Useful Routines](#9-pokes-and-other-useful-routines)
   - [9.1 The Cassette Buffer as Program Memory](#91-the-cassette-buffer-as-program-memory)
   - [9.2 Sorting String Fields](#92-sorting-string-fields)
   - [9.3 Minimum and Maximum of Numeric Fields](#93-minimum-and-maximum-of-field-variables)
   - [9.4 DUMP - Output of All Variables and Values](#94-dump-command-for-variable-output)
   - [9.5 Modified PEEK Function](#95-modified-peek-function)
   - [9.6 Multitasking on the Commodore 64](#96-multitasking-on-the-commodore-64)
   - [9.7 POKE's and the Zero Page](#97-pokes-and-the-zero-page)
   - [9.8 Control of Text Input via Keyboard](#98-control-of-text-entry-via-the-keyboard)
   - [9.9 Formatted Program Listing](#99-formatted-program-listing)
   - [9.10 Saving Variables and Warm Start](#910-saving-variables-and-warm-start)

## Commodore 64 graphics guide
...
## Commodore 64 programming instructions
...
## Commodore 64 sprite programming guide
...
## Commodore 64 3D graphics program
...
## Graphic plotting program instructions
...
## BASIC graphics programming code
...
## BASIC graphics plotting program
...
## BASIC programming code listing
...
## Machine program for colored bar charts
...
## BASIC programming code example
...
## Commodore 64 custom character guide
...
## Character matrix definition guide
...
## BASIC character definition program
...
## C64 character editor instructions
...
## Retro computer sprite memory guide
...
## C64 character generator documentation
...
## Commodore 64 assembly program listing
...
## BASIC game movement code snippet
...
## Commodore 64 raster interrupt guide
...
## Assembly code for video controller
...
## BASIC raster interrupt program code
...
## Technical document on soft scrolling
...
## BASIC code scroll effect program
...
## Commodore 64 keyboard technical manual
...
## Commodore 64 keyboard mapping guide
...
## Commodore keyboard remapping guide
...
## ZX Spectrum keyboard remapping guide
...
## BASIC key remapping program code
...
## Commodore 64 cursor positioning guide
...
## BASIC programming cursor control
...
## Commodore 64 cursor control guide
...
## BASIC programming code snippet
...
## Commodore 64 repeat function guide
...
## BASIC WAIT command documentation
...
## Commodore BASIC WAIT command guide
...
## Commodore 64 function key guide
...
## BASIC function key programming guide
...
## Keyboard function handling code
...
## Assembly code listing with comments
...
## BASIC program listing and notes
...
## Program address modification instructions
...
## Programming input routine guide
...
## Programming input validation guide
...
## Input routine documentation page
...
## C64 input validation code snippet
...
## BASIC input validation routine
...
## Article input program instructions
...
## German programming tutorial snippet
...
## Computer mouse technical explanation article
...
## Program variables and memory guide
...
## Commodore 64 cursor control code
...
## C64 joystick cursor control code
...
## Basic programming tutorial chapter


# CHAPTER 4 BASIC FOR ADVANCED USERS
...
## Programming guide for dynamic calculations
...
## Basic program memory allocation guide
...
## Commodore 64 BASIC machine code
...
## BASIC programming instructions listing
...
## Basic program generator explanation
...
## Commodore 64 BASIC interpreter guide
...
## BASIC programming return routine
...
## BASIC interpreter programming guide
...
## Assembly code modification guide
...
## BASIC RESTORE routine modification
...
## BASIC MID$ function documentation
...
## Commodore 64 BASIC string functions
...
## BASIC programming examples and functions
...
## BASIC machine code loader program
...
## Function definition example document
...
## Commodore 64 German error messages
...
```txt
6502 assembly error handler code
```
...
## Commodore 64 BASIC hardcopy routine
...
## BASIC printer output program code
...
## CBM64 clock program description
...
## Program variable documentation
...
## Program listing with timing logic
...
## Vintage BASIC clock program code
...
## Time tracking document summary
...
## Software copy protection analysis
...
## Software protection guide introduction
...
## BASIC floppy disk formatting code
...
## Basic copy protection demo code
...
## Software protection instructions manual
...
## Chapter 5: FORTH programming guide
...
## Forth programming language documentation
...
## Forth vs BASIC comparison guide
...
## Forth programming tutorial example
...
## Commodore 64 FORTH programming guide
...
## Forth programming language benefits
...
## Commodore 64 programming languages guide
...
## Turtle Graphics programming example
...
## Commodore 64 ADA programming guide
...
## Basic multiplication program code
...
## Chapter 6: CP/M on Commodore 64
...
## CP/M compatibility and limitations
...
## CP/M software compatibility guide
...
## CP/M operating system components guide
...
## CP/M system call reference guide
...
## CP/M function call documentation
...
## CP/M utility program descriptions
...
## Commodore 64 CP/M STAT command guide
...
## Floppy disk system documentation
...
## Commodore ED text editor guide
...
## CP/M disk layout documentation
...
## Commodore disk formatting instructions
...
## Commodore 64 CP/M processor cooperation
...
## Commodore 64 CP/M BIOS listing
...
## Commodore 64 BIOS assembly code
...
## 6502 assembly disk write routine
...
## Z80 assembly printer control code
...
## CP/M disk operation code listing
...
## Commodore keyboard layout chart
...
## Z80 boot routine documentation
...
## CP/M memory configuration code
...
## Z80 assembly I/O configuration code
...
## Commodore 64 boot code listing
...
## CP/M system initialization code
...
## Assembly code keyboard handling routine
...
## Assembly code console output routine
...
## CP/M disk sector constants table
...
## CP/M disk read/write assembly code
...
## CP/M disk allocation code snippet
...
## Assembly code error handling routine
...
## BIOS custom I/O function guide
...
## CP/M to Commodore 64 transfer guide
...
## Commodore data transfer instructions
...
## Commodore to CP/M data transfer guide
...
## CP/M file transfer instructions
...
## Commodore 64 technical manual chapter
...
## Commodore 64 printer interface guide
...
## Port definitions and initialization code
...
## Assembly code for I/O operations
...
## 6502 assembly file handling code
...
## Hexadecimal or binary data dump
...
## Userport to Centronics pinout guide
...
## CBM8032 Userport technical documentation
...
## Microcontroller user port documentation
...
## C64/CBM8032 communication program guide
...
## CBM8032 data transfer subroutine
...
## CBM64 data transfer subroutine
...
## Serial communication setup guide
...
## CP/M cartridge technical documentation
...
## C64 expansion port technical guide
...
## Z80 bus control technical explanation
...
## Z80 processor memory addressing guide
...
## Z80 cartridge programming guide
...
## C64 Z80 processor technical documentation
...
## Technical hardware documentation page
...
## C64 synthesizer stereo modification guide
...
## Audio filter circuit instructions
...
## Basic Commodore 64 assembly code
...
## Commodore 64 file management guide

# 8 FILE MANAGEMENT: NO CLOSED BOOK
...
## Database concepts explanation document
...
## Address database example table
...
## Commodore 64 cassette programming guide
...
## Commodore 64 file commands guide
...
## Commodore 64 disk storage guide
...
## Cassette vs. floppy comparison analysis
...
## Commodore data transfer protocol
...
## Sequential file management guide
...
## Commodore 64 data management guide
...
## Commodore 64 disk file handling
...
## Commodore 64 data storage program
...
## Commodore 64 data read program
...
## Commodore 64 data appending code
...
## Commodore 64 disk writing routine
...
## Floppy disk capacity explanation
...
## Floppy disk data storage guide
...
## Commodore 64 BASIC data program
...
## Sequential file description and usage
...
## Commodore 64 file copying guide
...
## Commodore 64 relative file guide
...
## Data record positioning instructions
...
## Data address calculation guide
...
## Diskette formatting instructions manual
...
## BASIC inventory management program
...
## German inventory management program
...
## Article management program code
...
## BASIC data management program code
...
## BASIC program error handling code
...
## Direct access disk method guide
...
## BASIC disk file allocation code
...
## Commodore 1541 floppy disk commands
...
## Disk recovery program instructions
...
## Floppy disk directory access code
...
## Floppy disk file recovery guide
...
## File recovery instructions and code
...
## BASIC file handling code snippet
...
## Block follower program documentation
...
## BASIC error handling subroutine
...
## Program code block descriptions
...
## Chapter 9: Machine code routines
...
## Commodore 64 memory management guide
...
## String sorting algorithm guide
...
```txt
6502 assembly and BASIC loader
```
...
## Assembly min/max function code
...
## Assembly code array processing
...
## Commodore 64 PEEK function modification
...
## BASIC programming memory expansion
...
## Commodore 64 multitasking explanation
...
## Commodore 64 time display program
...
## Multitasking application programming guide
...
## Commodore 64 interrupt programming guide
...
## POKE commands memory addresses guide
...
## Commodore 64 memory addresses guide
...
## Commodore 64 text case handling
...
## Bitwise operation code example
...
## Formatted BASIC program listing tool
...
## Program code listing and notes
...
## Programming warm start instructions manual
...
## Retro database software advertisement
...
## Commodore 64 machine language books
...
## Commodore 64 programming guide books
...
## Software product advertisement brochure
...
## KONTOMAT accounting software brochure
...
## FAKTUMAT invoicing software brochure
...
## Commodore 64 programming tools guide
...
## BASIC 64 compiler documentation
...
## Junior mathematics learning program description
...
## Software training book catalog
